...
public class Q9_SEQPatternLength10_IS {
    public static void main(String[] args) throws Exception {

        String className = "Q9_SEQPatternLength10_IS";
        ...
        DataStream<Tuple10<KeyedDataPointGeneral,KeyedDataPointGeneral,KeyedDataPointGeneral,KeyedDataPointGeneral,KeyedDataPointGeneral, KeyedDataPointGeneral, KeyedDataPointGeneral, KeyedDataPointGeneral, KeyedDataPointGeneral, KeyedDataPointGeneral>> result = patternStream.flatSelect(new UDFs.GetResultTuple10());
