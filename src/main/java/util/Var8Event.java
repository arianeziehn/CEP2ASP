...
public class Var8Event extends KeyedDataPointGeneral{
    ...
    public Var8Event(String key, long timeStampMs, Double value) {
        super(key, timeStampMs, value);
        this.type = "var8";
    }

    public Var8Event(String key, long timeStampMs, Double value, float longitude, float latitude) {
