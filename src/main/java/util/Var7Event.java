...
public class Var7Event extends KeyedDataPointGeneral{
    ...
    public Var7Event(String key, long timeStampMs, Double value) {
        super(key, timeStampMs, value);
        this.type = "var7";
    }

    public Var7Event(String key, long timeStampMs, Double value, float longitude, float latitude) {
